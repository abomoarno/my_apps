...
import afrimoov.gn.activities.Disclaimer;
import afrimoov.gn.activities.ModeCompact;
import afrimoov.gn.activities.Notifications;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.contact:
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT,"TV GUINEE");
