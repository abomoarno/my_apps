...
import static afrimoov.gn.alerts.AlarmInitialisation.NOTIFICATION_ID;
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                try {
                    ...
                    sendNotify(builder,"https://afrimoov.com/guineenews/images/" + image);
