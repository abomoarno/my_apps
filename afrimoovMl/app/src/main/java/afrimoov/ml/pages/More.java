...
import afrimoov.ml.activities.Accueil;
import afrimoov.ml.activities.Disclaimer;
import afrimoov.ml.activities.ModeCompact;
import afrimoov.ml.activities.Notifications;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.contact:
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT,"TV MALI");
