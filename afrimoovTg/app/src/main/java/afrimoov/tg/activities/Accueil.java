...
import afrimoov.tg.alerts.Pub_Interval;
import afrimoov.tg.pages.All_Direct_Tv;
import afrimoov.tg.pages.Home_Replay;
import afrimoov.tg.pages.More;
import afrimoov.tg.pages.Page_Accueil;
...
public class Accueil extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pub_Interval.initAds(Accueil.this,Utils.ADS_REMOVED);
    ...
    private void reviewReminder(){
        ...
        int review_modulo = preferences.getInt("review_modulo",3);
            ...
            builder.setPositiveButton(getString(R.string.noter), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    try {
                        ...
                        preferences.edit().putInt("review_modulo",preferences.getInt("review_modulo",3)+20).apply();
                    }
                }
            });
            builder.setNegativeButton(getString(R.string.annuler), new DialogInterface.OnClickListener() {
