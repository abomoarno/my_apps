...
import big.win.classes.MyCinetPayWebAppInterface;

public class Payment extends CinetPayActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.addJavascriptInterface(
                new MyCinetPayWebAppInterface(this, api_key, site_id, notify_url, trans_id, amount, currency, designation, custom, true),
                "Android");
    }
}
