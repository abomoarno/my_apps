...
public class TvPlayer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedTvChannel = getIntent().getParcelableExtra("replay");
    ...
    private void playTvChannel(){
        ...
        switch (selectedTvChannel.getPlateform()){
            case "youtube":
        ...
        mActionBar.setTitle(selectedTvChannel.getTitle());
        mActionBar.setSubtitle(selectedTvChannel.getChannel_name());
        titre.setText(selectedTvChannel.getTitle());
        channel.setText(selectedTvChannel.getChannel_name());
        date_pub.setText(selectedTvChannel.getQuery_date());

        Bundle args = new Bundle();

        args.putParcelable("replay", selectedTvChannel);
