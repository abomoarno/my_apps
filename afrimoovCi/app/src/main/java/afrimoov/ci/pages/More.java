...
import afrimoov.ci.activities.Accueil;
import afrimoov.ci.activities.Disclaimer;
import afrimoov.ci.activities.ModeCompact;
import afrimoov.ci.activities.Notifications;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.contact:
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT,"TV COTE D'IVOIRE");
