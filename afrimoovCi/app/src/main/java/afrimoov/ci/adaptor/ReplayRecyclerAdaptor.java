...
public class ReplayRecyclerAdaptor extends RecyclerView.Adapter<ReplayRecyclerAdaptor.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemView) {
            ...
            duree = itemView.findViewById(R.id.duration);
            vues = itemView.findViewById(R.id.live_vues);
        }
        ...
        void bind(final Replay replay, final OnItemClickListener listener){
            ...
            name.setText(title);
            source.setText(replay.getChannel());
            duree.setText(replay.getDuration());
            String views;
            if (replay.getVues() != 0) {
                views = context.getString(R.string.vues);
