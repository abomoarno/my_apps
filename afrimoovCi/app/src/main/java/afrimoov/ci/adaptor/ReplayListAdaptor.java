...
public class ReplayListAdaptor extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.source.setText(replay.getChannel());
        String vues = (replay.getVues() == 0) ? context.getString(R.string.nouveau) : replay.getVues()+" vues";
        String duree_vues = vues + " | " + replay.getDuration();
