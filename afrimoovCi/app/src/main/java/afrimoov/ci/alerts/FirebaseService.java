...
import static afrimoov.ci.alerts.AlarmInitialisation.NOTIFICATION_ID;
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                try {
                    ...
                    tv.setLive_vues(vues);
                    tv.setCategories(categorie);
                    tv.setLangue(langue);
                    tv.setImage(image);
                    tv.setPlatefome(plateforme);
                    ...
                    sendNotify(builder,"https://afrimoov.com/rtinews/images/" + image);
