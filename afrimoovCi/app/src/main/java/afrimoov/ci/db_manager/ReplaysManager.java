...
public class ReplaysManager {
    ...
    public void insertReplay(Replay replay){
        ...
        values.put(title,replay.getTitre());
        ...
        values.put(views,replay.getVues());
        values.put(id,replay.getReplay_id());
        values.put(chaine,replay.getChannel());
        values.put(duration,replay.getDuration());
