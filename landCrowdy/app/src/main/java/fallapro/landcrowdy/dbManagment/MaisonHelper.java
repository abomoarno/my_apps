...
public class MaisonHelper extends SQLiteOpenHelper {
    ...
    private static final String create_table_pronostics = "CREATE TABLE " + TABLE_MAISONS + " ("
    ...
    public MaisonHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
