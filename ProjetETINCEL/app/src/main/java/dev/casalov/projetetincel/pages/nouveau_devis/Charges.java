        ...
        switch (view.getId()){
            ...
            case R.id.next:
                ...
                if (!c_client.toString().isEmpty())
                    NouveauDevis.devis.setCharges_client(c_client.toString().substring(0,c_client.length()-1));
                else
                    NouveauDevis.devis.setCharges_client("");
                if (!c_etincel.toString().isEmpty())
                    NouveauDevis.devis.setCharges_etincel(c_etincel.toString().substring(0,c_etincel.length()-1));
                else
                    NouveauDevis.devis.setCharges_etincel("");
                activity.setFragment(new Prestations());
                break;
        }
    }
