...
import dev.casalov.projetetincel.pages.DetailsRapport.AppareilsMesure;

public class AppareilsAdaptor extends ArrayAdapter<String> {

    private List<String> elements_name;
    private List<String> elements_valeur;
    private Activity context;
    private AppareilsMesure fragment;

    public AppareilsAdaptor(@NonNull Activity context, List<String> elements_name, List<String> elements_valeur, AppareilsMesure fragment) {
